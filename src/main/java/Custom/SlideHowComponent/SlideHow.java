...
public class SlideHow extends JLayeredPane {
    ...
    public SlideHow() {
        ...
        animator = new Animator(500, target); // ANIMATION SPEED -------------------------------------
        ...
        add(panel, "w 100%-6!");
        timer = new Timer(Time, new ActionListener() { // AUTOMATIC CHANGE --------------
            @Override
    ...
    public void setAutoScroll(boolean TimeCondition) {
